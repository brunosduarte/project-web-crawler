...
import { type INodeStore } from './store/INodeStore'
import { type ITaskQueue } from './queue/ITaskQueue'
import cors from 'cors'
import { GetTree } from './use-cases/GetTree'
...
export class Server {
  ...
  private readonly store: INodeStore
  ...
  constructor (private readonly options: IServerOptions) {
    ...
    this.server
      ...
      .get('/domain', this.getQueueStatus.bind(this))
  }
